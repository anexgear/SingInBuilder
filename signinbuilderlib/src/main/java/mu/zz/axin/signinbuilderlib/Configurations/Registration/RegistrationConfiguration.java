...
public class RegistrationConfiguration extends BaseConfiguration implements RegistrationInterface {
    ...
    public RegistrationConfiguration(Screen screen) {
        initView(screen);
    }

    @Override
    public RegistrationConfiguration autocomplete() {
        autocomplete = true;
        return this;
    }

    @Override
    public RegistrationConfiguration necessarilyText(TextType type) {
        this.necessarily = type;
        return this;
    }

    @Override
    public RegistrationConfiguration validateText(TextType type) {
        this.validate = type;
        return this;
    }

    @Override
    public RegistrationConfiguration disableRegisterButton() {
        disableButton = true;
        return this;
    }
